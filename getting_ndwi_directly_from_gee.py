# -*- coding: utf-8 -*-
"""Getting_NDWI_directly from_GEE.ipynb
...
#getting ndvi dataset
#ndvi_set = ee.ImageCollection("LANDSAT/LC8_L1T_32DAY_NDVI")
...
#setting ndvi for the perspective / time period
#NDVI = ndvi_set.select('NDVI')\ 
# .filterDate('2016-01-01', '2017-01-01')\
# .reduce(ee.Reducer.mean())\
# .clip(aoi)

#setting ndwi for the perspective / time period
NDWI = ndwi_set.select('NDWI')\
 .filterDate('2016-01-01', '2017-01-01')\
 .reduce(ee.Reducer.mean())\
 .clip(aoi)

#visualizing the colors of according to the range
colVis = {
  'min': 0.0,
  'max': 1.0,
